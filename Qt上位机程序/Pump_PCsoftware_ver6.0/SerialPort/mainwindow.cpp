    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->pushButton_PumpA->setStyleSheet("QPushButton{background-color:gray;\
     ...
     ui->pushButton_PumpB->setStyleSheet("QPushButton{background-color:gray;\
                                         color:white; border-radius:5px; border:2px groove gray;\
                                         border-style:outset;}"
                                         "QPushButton:hover{background-color:white;color:black;}"
                                         "QPushButton:pressed{background-color:rgb(85,170,255);\
    ...
    this->setWindowTitle("进样蠕动泵控制系统 ver6.0");
...
void MainWindow::on_openButton_clicked()
{
    if(ui->openButton->text()==tr("打开串口"))
    {
        ...
        //打开串口之后先发送一个字符串，看看会怎样
        ui->textEdit_2->setText("Activate");
